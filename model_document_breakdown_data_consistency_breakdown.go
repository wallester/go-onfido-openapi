...
// checks if the DocumentBreakdownDataConsistencyBreakdown type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentBreakdownDataConsistencyBreakdown{}

// DocumentBreakdownDataConsistencyBreakdown struct for DocumentBreakdownDataConsistencyBreakdown
type DocumentBreakdownDataConsistencyBreakdown struct {
	...
	MultipleDataSourcesPresent *DocumentBreakdownDataComparisonBreakdownIssuingCountry `json:"multiple_data_sources_present,omitempty"`
}
...
func NewDocumentBreakdownDataConsistencyBreakdown() *DocumentBreakdownDataConsistencyBreakdown {
	this := DocumentBreakdownDataConsistencyBreakdown{}
	return &this
}
...
// GetMultipleDataSourcesPresent returns the MultipleDataSourcesPresent field value if set, zero value otherwise.
func (o *DocumentBreakdownDataConsistencyBreakdown) GetMultipleDataSourcesPresent() DocumentBreakdownDataComparisonBreakdownIssuingCountry {
	if o == nil || IsNil(o.MultipleDataSourcesPresent) {
		var ret DocumentBreakdownDataComparisonBreakdownIssuingCountry
		return ret
	}
	return *o.MultipleDataSourcesPresent
}

// GetMultipleDataSourcesPresentOk returns a tuple with the MultipleDataSourcesPresent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DocumentBreakdownDataConsistencyBreakdown) GetMultipleDataSourcesPresentOk() (*DocumentBreakdownDataComparisonBreakdownIssuingCountry, bool) {
	...
	return o.MultipleDataSourcesPresent, true
}
...
// SetMultipleDataSourcesPresent gets a reference to the given DocumentBreakdownDataComparisonBreakdownIssuingCountry and assigns it to the MultipleDataSourcesPresent field.
func (o *DocumentBreakdownDataConsistencyBreakdown) SetMultipleDataSourcesPresent(v DocumentBreakdownDataComparisonBreakdownIssuingCountry) {
	o.MultipleDataSourcesPresent = &v
}

func (o DocumentBreakdownDataConsistencyBreakdown) MarshalJSON() ([]byte, error) {
...
func (o DocumentBreakdownDataConsistencyBreakdown) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MultipleDataSourcesPresent) {
		toSerialize["multiple_data_sources_present"] = o.MultipleDataSourcesPresent
	}
	return toSerialize, nil
}

type NullableDocumentBreakdownDataConsistencyBreakdown struct {
	value *DocumentBreakdownDataConsistencyBreakdown
	isSet bool
}

func (v NullableDocumentBreakdownDataConsistencyBreakdown) Get() *DocumentBreakdownDataConsistencyBreakdown {
	return v.value
}

func (v *NullableDocumentBreakdownDataConsistencyBreakdown) Set(val *DocumentBreakdownDataConsistencyBreakdown) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentBreakdownDataConsistencyBreakdown) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentBreakdownDataConsistencyBreakdown) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentBreakdownDataConsistencyBreakdown(val *DocumentBreakdownDataConsistencyBreakdown) *NullableDocumentBreakdownDataConsistencyBreakdown {
	return &NullableDocumentBreakdownDataConsistencyBreakdown{value: val, isSet: true}
}

func (v NullableDocumentBreakdownDataConsistencyBreakdown) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentBreakdownDataConsistencyBreakdown) UnmarshalJSON(src []byte) error {
	v.isSet = true
