...
// checks if the RightToWorkReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RightToWorkReport{}

// RightToWorkReport struct for RightToWorkReport
type RightToWorkReport struct {
	...
	Breakdown  *RightToWorkBreakdown  `json:"breakdown,omitempty"`
	Properties *RightToWorkProperties `json:"properties,omitempty"`
}

type _RightToWorkReport RightToWorkReport
...
// SetBreakdown gets a reference to the given RightToWorkBreakdown and assigns it to the Breakdown field.
...
// SetProperties gets a reference to the given RightToWorkProperties and assigns it to the Properties field.
func (o *RightToWorkReport) SetProperties(v RightToWorkProperties) {
	o.Properties = &v
}

func (o RightToWorkReport) MarshalJSON() ([]byte, error) {
...
func (o RightToWorkReport) ToMap() (map[string]interface{}, error) {
...
func (o *RightToWorkReport) UnmarshalJSON(data []byte) (err error) {
	...
	varRightToWorkReport := _RightToWorkReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRightToWorkReport)

	if err != nil {
		return err
	}

	*o = RightToWorkReport(varRightToWorkReport)

	return err
}

type NullableRightToWorkReport struct {
	value *RightToWorkReport
	isSet bool
}

func (v NullableRightToWorkReport) Get() *RightToWorkReport {
	return v.value
}

func (v *NullableRightToWorkReport) Set(val *RightToWorkReport) {
	v.value = val
	v.isSet = true
}

func (v NullableRightToWorkReport) IsSet() bool {
	return v.isSet
}

func (v *NullableRightToWorkReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRightToWorkReport(val *RightToWorkReport) *NullableRightToWorkReport {
	return &NullableRightToWorkReport{value: val, isSet: true}
}

func (v NullableRightToWorkReport) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRightToWorkReport) UnmarshalJSON(src []byte) error {
	v.isSet = true
