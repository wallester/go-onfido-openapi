...
`func (o *WatchlistSanctionsOnlyReport) SetReadOnlyNil(b bool)`

 SetReadOnlyNil sets the value for ReadOnly to be an explicit nil

### UnsetReadOnly
`func (o *WatchlistSanctionsOnlyReport) UnsetReadOnly()`
...
`func (o *WatchlistSanctionsOnlyReport) GetIdPhotos() []FacialSimilarityReportMedia`

GetIdPhotos returns the IdPhotos field if non-nil, zero value otherwise.

### GetIdPhotosOk

`func (o *WatchlistSanctionsOnlyReport) GetIdPhotosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistSanctionsOnlyReport) SetIdPhotos(v []FacialSimilarityReportMedia)`

SetIdPhotos sets IdPhotos field to given value.

### HasIdPhotos

`func (o *WatchlistSanctionsOnlyReport) HasIdPhotos() bool`

HasIdPhotos returns a boolean if a field has been set.

### GetLivePhotos

`func (o *WatchlistSanctionsOnlyReport) GetLivePhotos() []FacialSimilarityReportMedia`

GetLivePhotos returns the LivePhotos field if non-nil, zero value otherwise.

### GetLivePhotosOk

`func (o *WatchlistSanctionsOnlyReport) GetLivePhotosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistSanctionsOnlyReport) SetLivePhotos(v []FacialSimilarityReportMedia)`

SetLivePhotos sets LivePhotos field to given value.

### HasLivePhotos

`func (o *WatchlistSanctionsOnlyReport) HasLivePhotos() bool`

HasLivePhotos returns a boolean if a field has been set.

### GetLiveVideos

`func (o *WatchlistSanctionsOnlyReport) GetLiveVideos() []FacialSimilarityReportMedia`

GetLiveVideos returns the LiveVideos field if non-nil, zero value otherwise.

### GetLiveVideosOk

`func (o *WatchlistSanctionsOnlyReport) GetLiveVideosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistSanctionsOnlyReport) SetLiveVideos(v []FacialSimilarityReportMedia)`

SetLiveVideos sets LiveVideos field to given value.

### HasLiveVideos

`func (o *WatchlistSanctionsOnlyReport) HasLiveVideos() bool`

HasLiveVideos returns a boolean if a field has been set.

### GetMotionCaptures

`func (o *WatchlistSanctionsOnlyReport) GetMotionCaptures() []FacialSimilarityReportMedia`

GetMotionCaptures returns the MotionCaptures field if non-nil, zero value otherwise.

### GetMotionCapturesOk

`func (o *WatchlistSanctionsOnlyReport) GetMotionCapturesOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistSanctionsOnlyReport) SetMotionCaptures(v []FacialSimilarityReportMedia)`

SetMotionCaptures sets MotionCaptures field to given value.

### HasMotionCaptures

`func (o *WatchlistSanctionsOnlyReport) HasMotionCaptures() bool`
