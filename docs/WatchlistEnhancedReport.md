...
`func (o *WatchlistEnhancedReport) GetIdPhotos() []FacialSimilarityReportMedia`

GetIdPhotos returns the IdPhotos field if non-nil, zero value otherwise.

### GetIdPhotosOk

`func (o *WatchlistEnhancedReport) GetIdPhotosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistEnhancedReport) SetIdPhotos(v []FacialSimilarityReportMedia)`

SetIdPhotos sets IdPhotos field to given value.

### HasIdPhotos

`func (o *WatchlistEnhancedReport) HasIdPhotos() bool`

HasIdPhotos returns a boolean if a field has been set.

### GetLivePhotos

`func (o *WatchlistEnhancedReport) GetLivePhotos() []FacialSimilarityReportMedia`

GetLivePhotos returns the LivePhotos field if non-nil, zero value otherwise.

### GetLivePhotosOk

`func (o *WatchlistEnhancedReport) GetLivePhotosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistEnhancedReport) SetLivePhotos(v []FacialSimilarityReportMedia)`

SetLivePhotos sets LivePhotos field to given value.

### HasLivePhotos

`func (o *WatchlistEnhancedReport) HasLivePhotos() bool`

HasLivePhotos returns a boolean if a field has been set.

### GetLiveVideos

`func (o *WatchlistEnhancedReport) GetLiveVideos() []FacialSimilarityReportMedia`

GetLiveVideos returns the LiveVideos field if non-nil, zero value otherwise.

### GetLiveVideosOk

`func (o *WatchlistEnhancedReport) GetLiveVideosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistEnhancedReport) SetLiveVideos(v []FacialSimilarityReportMedia)`

SetLiveVideos sets LiveVideos field to given value.

### HasLiveVideos

`func (o *WatchlistEnhancedReport) HasLiveVideos() bool`

HasLiveVideos returns a boolean if a field has been set.

### GetMotionCaptures

`func (o *WatchlistEnhancedReport) GetMotionCaptures() []FacialSimilarityReportMedia`

GetMotionCaptures returns the MotionCaptures field if non-nil, zero value otherwise.

### GetMotionCapturesOk

`func (o *WatchlistEnhancedReport) GetMotionCapturesOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *WatchlistEnhancedReport) SetMotionCaptures(v []FacialSimilarityReportMedia)`

SetMotionCaptures sets MotionCaptures field to given value.

### HasMotionCaptures

`func (o *WatchlistEnhancedReport) HasMotionCaptures() bool`
