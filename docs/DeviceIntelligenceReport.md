...
`func (o *DeviceIntelligenceReport) GetIdPhotos() []FacialSimilarityReportMedia`

GetIdPhotos returns the IdPhotos field if non-nil, zero value otherwise.

### GetIdPhotosOk

`func (o *DeviceIntelligenceReport) GetIdPhotosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *DeviceIntelligenceReport) SetIdPhotos(v []FacialSimilarityReportMedia)`

SetIdPhotos sets IdPhotos field to given value.

### HasIdPhotos

`func (o *DeviceIntelligenceReport) HasIdPhotos() bool`

HasIdPhotos returns a boolean if a field has been set.

### GetLivePhotos

`func (o *DeviceIntelligenceReport) GetLivePhotos() []FacialSimilarityReportMedia`

GetLivePhotos returns the LivePhotos field if non-nil, zero value otherwise.

### GetLivePhotosOk

`func (o *DeviceIntelligenceReport) GetLivePhotosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *DeviceIntelligenceReport) SetLivePhotos(v []FacialSimilarityReportMedia)`

SetLivePhotos sets LivePhotos field to given value.

### HasLivePhotos

`func (o *DeviceIntelligenceReport) HasLivePhotos() bool`

HasLivePhotos returns a boolean if a field has been set.

### GetLiveVideos

`func (o *DeviceIntelligenceReport) GetLiveVideos() []FacialSimilarityReportMedia`

GetLiveVideos returns the LiveVideos field if non-nil, zero value otherwise.

### GetLiveVideosOk

`func (o *DeviceIntelligenceReport) GetLiveVideosOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *DeviceIntelligenceReport) SetLiveVideos(v []FacialSimilarityReportMedia)`

SetLiveVideos sets LiveVideos field to given value.

### HasLiveVideos

`func (o *DeviceIntelligenceReport) HasLiveVideos() bool`

HasLiveVideos returns a boolean if a field has been set.

### GetMotionCaptures

`func (o *DeviceIntelligenceReport) GetMotionCaptures() []FacialSimilarityReportMedia`

GetMotionCaptures returns the MotionCaptures field if non-nil, zero value otherwise.

### GetMotionCapturesOk

`func (o *DeviceIntelligenceReport) GetMotionCapturesOk() (*[]FacialSimilarityReportMedia, bool)`
...
`func (o *DeviceIntelligenceReport) SetMotionCaptures(v []FacialSimilarityReportMedia)`

SetMotionCaptures sets MotionCaptures field to given value.

### HasMotionCaptures

`func (o *DeviceIntelligenceReport) HasMotionCaptures() bool`
