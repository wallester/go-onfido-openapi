...
// checks if the DeviceIntelligenceReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceIntelligenceReport{}

// DeviceIntelligenceReport struct for DeviceIntelligenceReport
type DeviceIntelligenceReport struct {
	...
	Breakdown  *DeviceIntelligenceBreakdown  `json:"breakdown,omitempty"`
	Properties *DeviceIntelligenceProperties `json:"properties,omitempty"`
}

type _DeviceIntelligenceReport DeviceIntelligenceReport
...
func (o *DeviceIntelligenceReport) GetBreakdown() DeviceIntelligenceBreakdown {
	if o == nil || IsNil(o.Breakdown) {
		var ret DeviceIntelligenceBreakdown
		return ret
	}
	return *o.Breakdown
}
...
// SetBreakdown gets a reference to the given DeviceIntelligenceBreakdown and assigns it to the Breakdown field.
...
func (o *DeviceIntelligenceReport) GetProperties() DeviceIntelligenceProperties {
	if o == nil || IsNil(o.Properties) {
		var ret DeviceIntelligenceProperties
		return ret
	}
	return *o.Properties
}
...
// SetProperties gets a reference to the given DeviceIntelligenceProperties and assigns it to the Properties field.
func (o *DeviceIntelligenceReport) SetProperties(v DeviceIntelligenceProperties) {
	o.Properties = &v
}

func (o DeviceIntelligenceReport) MarshalJSON() ([]byte, error) {
...
func (o DeviceIntelligenceReport) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceIntelligenceReport) UnmarshalJSON(data []byte) (err error) {
	...
	varDeviceIntelligenceReport := _DeviceIntelligenceReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields() - disabled to allow unknown fields from Onfido API
	err = decoder.Decode(&varDeviceIntelligenceReport)

	if err != nil {
		return err
	}

	*o = DeviceIntelligenceReport(varDeviceIntelligenceReport)

	return err
}

type NullableDeviceIntelligenceReport struct {
	value *DeviceIntelligenceReport
	isSet bool
}

func (v NullableDeviceIntelligenceReport) Get() *DeviceIntelligenceReport {
	return v.value
}

func (v *NullableDeviceIntelligenceReport) Set(val *DeviceIntelligenceReport) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceIntelligenceReport) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceIntelligenceReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceIntelligenceReport(val *DeviceIntelligenceReport) *NullableDeviceIntelligenceReport {
	return &NullableDeviceIntelligenceReport{value: val, isSet: true}
}

func (v NullableDeviceIntelligenceReport) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceIntelligenceReport) UnmarshalJSON(src []byte) error {
	v.isSet = true
