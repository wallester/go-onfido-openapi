...
// checks if the DocumentWithAddressInformationReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentWithAddressInformationReport{}
...
type _DocumentWithAddressInformationReport DocumentWithAddressInformationReport
...
func NewDocumentWithAddressInformationReport(name string) *DocumentWithAddressInformationReport {
	this := DocumentWithAddressInformationReport{}
	this.Name = name
	return &this
}
...
func (o DocumentWithAddressInformationReport) MarshalJSON() ([]byte, error) {
...
func (o *DocumentWithAddressInformationReport) UnmarshalJSON(data []byte) (err error) {
	...
	*o = DocumentWithAddressInformationReport(varDocumentWithAddressInformationReport)

	return err
}

type NullableDocumentWithAddressInformationReport struct {
	value *DocumentWithAddressInformationReport
	isSet bool
}

func (v NullableDocumentWithAddressInformationReport) Get() *DocumentWithAddressInformationReport {
	return v.value
}

func (v *NullableDocumentWithAddressInformationReport) Set(val *DocumentWithAddressInformationReport) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentWithAddressInformationReport) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentWithAddressInformationReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentWithAddressInformationReport(val *DocumentWithAddressInformationReport) *NullableDocumentWithAddressInformationReport {
	return &NullableDocumentWithAddressInformationReport{value: val, isSet: true}
}

func (v NullableDocumentWithAddressInformationReport) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentWithAddressInformationReport) UnmarshalJSON(src []byte) error {
	v.isSet = true
