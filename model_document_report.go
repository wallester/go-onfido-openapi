...
// checks if the DocumentReport type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentReport{}

// DocumentReport struct for DocumentReport
...
type _DocumentReport DocumentReport
...
func (o DocumentReport) MarshalJSON() ([]byte, error) {
...
func (o DocumentReport) ToMap() (map[string]interface{}, error) {
...
func (o *DocumentReport) UnmarshalJSON(data []byte) (err error) {
	...
	varDocumentReport := _DocumentReport{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	// decoder.DisallowUnknownFields() - disabled to allow unknown fields from Onfido API
	err = decoder.Decode(&varDocumentReport)

	if err != nil {
		return err
	}

	*o = DocumentReport(varDocumentReport)

	return err
}

type NullableDocumentReport struct {
	value *DocumentReport
	isSet bool
}

func (v NullableDocumentReport) Get() *DocumentReport {
	return v.value
}

func (v *NullableDocumentReport) Set(val *DocumentReport) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentReport) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentReport) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentReport(val *DocumentReport) *NullableDocumentReport {
	return &NullableDocumentReport{value: val, isSet: true}
}

func (v NullableDocumentReport) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentReport) UnmarshalJSON(src []byte) error {
	v.isSet = true
